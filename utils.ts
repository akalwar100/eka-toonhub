...
import { useLiveVehicleData, isLiveDataConfigured, isUsingLocalMock } from '@/data/liveData';
      ...
      {(phase === 'orbital' || phase === 'zooming-out') && vehicle && (
        ...
        >
          <RadialOrbitalTimeline
            ...
            onClose={handleClose}
            isLive={isLiveDataConfigured() || isUsingLocalMock()}
            liveLabel={isLiveDataConfigured() ? 'Live region data' : 'Live (local dev mock)'}
          />
        </div>
      )}
